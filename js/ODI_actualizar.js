function ActualizarODI(){
    ...
    var funcionRespuesta = 'respuestaODI(respuestaServidor)';
    ...
    var dataFormulario = capturarValoresFormulario('form_odi_actualizar');
...
function respuestaODI(respuestaServidor) {
